...
randomword(1000) #you may change this according to the speed of the processor
#if the system is slow, it may take time to compute the lcs.
#please choose the length wisely
